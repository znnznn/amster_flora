...
interface CityPopupProps extends React.HTMLAttributes<HTMLButtonElement> {
    withIcon?: boolean
}

export const CityPopup = ({ withIcon = false, className }: CityPopupProps) => {
    const [mounted, setMounted] = useState(false)
    const [city, setCity] = useCookie('NEXT_CITY', DEFAULT_CITY)
    const [isCitySelectionMode, setIsCitySelectionMode] = useState(false)
    const [isSheetOpen, setIsSheetOpen] = useState(false)

    const t = useTranslations('Common.CityPopup')
