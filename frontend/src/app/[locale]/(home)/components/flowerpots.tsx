...
import flowerpot from '@/assets/images/home/flowerpot.png'
...
export const Flowerpots = () => {
    ...
    return (
        <div className='overflow-x-clip'>
            <Section
                className='mt-32 pl-20 max-sm:pl-4'
                ref={ref}
            >
                <div className='relative flex justify-end rounded-lg border p-8 max-md:p-4 max-sm:justify-start'>
                    ...
                    >
                        <H2>{t('FlowerPots.Title')}</H2>
                        <p className='max-w-[500px] font-medium max-lg:max-w-[370px]'>
                            {t('FlowerPots.Desctiption')}
                        </p>
                        <Link href='/catalogue'>
                            <Button variant='accent'>{t('FlowerPots.Button')}</Button>
                        </Link>
                    </motion.div>
                    <motion.div
                        animate={controls}
