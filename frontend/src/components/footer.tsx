...
export const Footer = () => {
    return (
        <footer className='mt-28 bg-primary pb-5 pt-10 max-md:mt-16'>
            <div className='container grid grid-cols-4 gap-8 text-accent max-lg:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1'>
                <div>
                    <Logo />
