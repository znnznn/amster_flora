        ...
        <Popover>
            <PopoverTrigger asChild>
                <Button
                    type='button'
                    variant='outline'
                    className='flex h-12 gap-1 rounded-e-none rounded-s-lg border-r-0 border-border bg-background px-3 focus:z-10'
                    disabled={disabled}>
                    <FlagComponent
...
const FlagComponent = ({ country, countryName }: RPNInput.FlagProps) => {
    ...
    return (
        <span className='flex h-4 w-6 flex-shrink-0 items-center justify-center overflow-hidden rounded bg-foreground/20 [&_svg]:size-full'>
